...
export const myPlacesStatusConfig = {
  APPROVED: {
    label: getPlaceStatusLabel("APPROVED"),
    badgeClassName: getPlaceStatusBadgeClassName("APPROVED"),
  ...
  PENDING: {
    label: getPlaceStatusLabel("PENDING"),
    badgeClassName: getPlaceStatusBadgeClassName("PENDING"),
  ...
  REJECTED: {
    label: getPlaceStatusLabel("REJECTED"),
    badgeClassName: getPlaceStatusBadgeClassName("REJECTED"),
